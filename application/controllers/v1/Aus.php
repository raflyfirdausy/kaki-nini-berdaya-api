...
class Aus extends REST_Controller
{
    public function __construct()
    {
        parent::__construct();        
        $this->load->model("Tr_aus_model", "trAus");
        $this->load->model("Vaus_model", "vAus");

        $this->viewModel    = $this->vAus;
        $this->model        = $this->trAus;
        $this->title        = "Anak Usia Dini";
    }
    ...
    public function index_post()
    {
        ...
        if (empty($imunisasi_tt)) {
            return $this->response(array(
                "status"                => true,
                "response_code"         => REST_Controller::HTTP_NOT_FOUND,
                "response_message"      => "Imunisasi TT tidak diketahui",
                "data"                  => NULL
            ), REST_Controller::HTTP_OK);
        }
